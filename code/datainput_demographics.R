...
cfg["population.numwomen"] <- 1000#2000
cfg["population.nummen"] <- 1000#2000
...
cfg["hivseed.amount"] <- 10#20     # 50 out of 10000 is 0.5% of the population
...
#save(cfgABC, file=paste0(datadir, "cfgABC.rda"))
